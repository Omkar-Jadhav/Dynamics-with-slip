...
mc = 2;                      % Mass of the Robot platform only
mr=mc;
...
dist='Y'        %Add the disturbance or not?  -----> 'Y' for yes
...
wn=0.3;                 %Natual frequency of the system
zeta=5;                 %Damping ratio of the system
...
[t,v]=ode23s(@(t,v) Controller(t,v,Vr,omega_r,Kv,Kw,Kiv,Kiw,R,mr,b,Meq,Jeq,...
    mewR,mewL,mew_change,dist,P1,P2,Iwy,L,N,T_roll),timespan,[0;0;0;0]);
%% Retracing the intermediate values for plotting
[~,Vdot ,omega_dot, t1_ddot, t2_ddot, sr, sl Tr Tl flong_1 flong_2] = cellfun(@(t,v)  Controller(t,v.',Vr,omega_r,Kv,Kw,Kiv,Kiw,R,...
    mr,b,Meq,Jeq,mewR,mewL,mew_change,dist,P1,P2,Iwy,L,N,T_roll), num2cell(t),...
                                        num2cell(v,2),'uni',0);
Vdot=cell2mat(Vdot);
